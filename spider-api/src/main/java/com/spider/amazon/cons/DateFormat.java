...
public class DateFormat {
    ...
    public final static String YEAR_MONTH_DAY_MMddyy1 = "MM/dd/yy";
    public final static String YEAR_MONTH_DAY_Mdyy = "M-d-yy";
    public final static String YEAR_MONTH_DAY_Mdyy1 = "M/d/yy";
    public final static String BOP_YMD_HMS = "yyyy-MM-ddTHH:mm:ss";
